...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "بعد انتهاء الفعالية، تتحول تذكرتك إلى NFT تذكاري خالد. يمكنك الاحتفاظ به في مجموعتك، تداوله كأصل نادر، أو حرقه مقابل مكافآت ونقاط ولاء لاستخدامها في فعاليات مستقبيلة."
    }
  ];
